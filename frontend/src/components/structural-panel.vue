...
const GAP_LABELS = {
  es: {
    ...
    procedural_gap: 'Oportunidad de fortalecimiento · procedimiento',
    coordination_gap: 'Oportunidad de fortalecimiento · coordinación',
    federal_implementation_gap: 'Oportunidad de fortalecimiento · implementación federal',
    rights_safeguard_gap: 'Oportunidad de fortalecimiento · salvaguarda de derechos',
    oversight_gap: 'Oportunidad de fortalecimiento · control',
    budget_capacity_gap: 'Oportunidad de fortalecimiento · presupuesto/capacidad',
